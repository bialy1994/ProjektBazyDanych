...
CREATE TABLE `opieka` (
  `idOpieka` int(11) NOT NULL,
  `dataPoczatku` date DEFAULT NULL,
  `dataKonca` date DEFAULT NULL,
  `idUzytkownik` int(11) NOT NULL,
  `idPojazd` int(11) NOT NULL,
  PRIMARY KEY (`idOpieka`),
  KEY `idPojazd` (`idPojazd`),
  KEY `idUzytkownik` (`idUzytkownik`),
  CONSTRAINT `opieka_ibfk_1` FOREIGN KEY (`idPojazd`) REFERENCES `pojazd` (`idPojazd`),
  CONSTRAINT `opieka_ibfk_2` FOREIGN KEY (`idUzytkownik`) REFERENCES `uzytkownik` (`idUzytkownik`)
